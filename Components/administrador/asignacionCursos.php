  ...
  <table id="registroTabla" class="table table-striped table-bordered" style="width:100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <button class="btn btn-danger" data-toggle="modal" data-target="#eliminarAsignacion"
      ...
      <form id="addCourse" name="formulario" method="POST">
        ...
        <div class="modal-body">
         ...
         ?>
          ...
          <div id="addc"></div>
          <button type="button" name="add" id="add" class="btn btn-success" onclick="AgregarMas()">Agregar M谩s</button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <table id="registroTabla" class="table table-striped table-bordered" style="width:100%">
          ...
          <?php
            include_once '../../conexion2.php';
            $result =  mysqli_query($base, 'SELECT id_curso, nombre_curso, id_grado, nombre_grado, nombre_nivel FROM curso
            ...
            <tr>
              ...
              <td>
                <button class="btn btn-danger" data-toggle="modal" data-target="#eliminarCurso"
                onclick="eliminarCur('<?php echo $datos; ?>')">
                  <span class="material-icons">
                    delete_forever
                  </span>
               </button>
...
<div id="eliminarCurso" class="modal fade">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
      ...
      <div class="modal-body">
        <form id="assigment2" name="formulario">
          <input type="hidden" name="idCurso" id="idCurso">
          <input type="hidden" name="idGradoEliminar" id="idGradoEliminar">
          <div class="alert alert-danger" role="alert">
            ¿Esta seguro que desea borrar esta Curso? Una vez borrado el curso se eliminaran los 
            anuncios y las tareas que publico el maestro y no se podran recuperar.
          </div>
        </form>
      </div>
      <div class="modal-footer">
        <div class="submit">
          <input type="submit" value="Eliminar Curso" id="eliminarCurso1" class="btn btn-danger" />
        </div>
      </div>
    </div>
  </div>
...
<!-- Modal para advertir al usuario si desea eliminar la asignacion del maestro -->
<div id="eliminarAsignacion" class="modal fade">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
